...
$(document).on("click", "#sidebarnav a.has-arrow", function(e) {
    if ($(this).parents("li").hasClass("active")) {
        $(".has-arrow").attr("aria-expanded", "false");
        $("#sidebarnav").children("li").removeClass("active");
        $("#sidebarnav").children("li").children("ul").attr("aria-expanded", "false");
        $("#sidebarnav").children("li").children("ul").removeClass("in");
        $(this).attr("aria-expanded", "false");
        $(this).parents("li").removeClass("active");
        $(this).parents("li").children("ul").attr("aria-expanded", "false");
        $(this).parents("li").children("ul").removeClass("in");
    } else {
        $(".has-arrow").attr("aria-expanded", "false");
        $("#sidebarnav").children("li").removeClass("active");
        $("#sidebarnav").children("li").children("ul").attr("aria-expanded", "false");
        ...
        $(this).parents("li").children("ul").attr("aria-expanded", "true");
        $(this).parents("li").children("ul").addClass("in");
    }
});
